...
xml.feed :xmlns => 'http://www.w3.org/2005/Atom', "xmlns:opensearch" => "http://a9.com/-/spec/opensearch/1.1/" do |atom|
  ...
  atom.link :href => url_for(:action => 'index', :q => @query, :page => 1, :only_path => false, :escape => false), :rel => 'first', :type => 'application/atom+xml'
  atom.link :href => url_for(:action => 'index', :q => @query, :page => @assets.total_pages, :only_path => false, :escape => false), :rel => 'last', :type => 'application/atom+xml'
  if @assets.next_page
    atom.link :href => url_for(:action => 'index', :q => @query, :page => @assets.next_page, :only_path => false, :escape => false), :rel => 'next', :type => 'application/atom+xml'
  end
  if @assets.previous_page
    atom.link :href => url_for(:action => 'index', :q => @query, :page => @assets.previous_page, :only_path => false, :escape => false), :rel => 'previous', :type => 'application/atom+xml'
  end
